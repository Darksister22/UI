...
class InstructorEditMain extends StatefulWidget {
  static const String id = 'semedit';
  const InstructorEditMain({Key? key}) : super(key: key);

  @override
  _InstructorEditMainState createState() => _InstructorEditMainState();
}

class _InstructorEditMainState extends State<InstructorEditMain> {
  ...
  Widget build(BuildContext context) {
    return AdminScaffold(
        ...
        backgroundColor: light,
        sideBar: _sideBarWidget.SideBarMenus(context, InstructorEditMain.id),
